...
public class GradesCard : ICard
{
    ...
    public GradesCard(){
        gradesDelta = rnd.Next(5, 10);
        partyingDelta = 0;
        turnsTillGraduationDelta = rnd.Next(-30, -5);
        hungerDelta = rnd.Next(-50, -5);
        cashDelta = 0;
        ...
        cardTitleText.text = "Grades Card";
        ...
        cardFlavorText.text = "Grades Card";
