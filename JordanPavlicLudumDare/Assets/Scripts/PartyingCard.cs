...
public class PartyingCard : ICard
{
    ...
    public PartyingCard(){
        gradesDelta = rnd.Next(-100, -5);
        partyingDelta = rnd.Next(5, 100);
        turnsTillGraduationDelta = rnd.Next(1, 5);
        hungerDelta = rnd.Next(-20, 5);
        cashDelta = rnd.Next(-1000, -10);
        ...
        cardFlavorText.text = "Party Card";
